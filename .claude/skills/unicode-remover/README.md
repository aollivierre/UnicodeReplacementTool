...
**Primary source**: `<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py`
...
- **AI Engineer Setup**: `<INSTALL_DIR>\AI-ENGINEER-SETUP-GUIDE.md`
- **VS Code Extension**: `<INSTALL_DIR>\RUNONSAVE-SETUP.md`
- **Tool History**: `<INSTALL_DIR>\vscode.ext\memory.md`
