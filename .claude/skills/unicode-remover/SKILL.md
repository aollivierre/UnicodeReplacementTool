...
**Script Location**: `<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py`
...
```bash
python "<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py" "<FILEPATH>" --preview
```
...
**If script not found**:
- Verify path: `<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py`
...
- **AI Engineer Setup Guide**: `<INSTALL_DIR>\AI-ENGINEER-SETUP-GUIDE.md`
- **User Guide**: `<INSTALL_DIR>\RUNONSAVE-SETUP.md`
- **Script Source**: `<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py`
- **VS Code Extension Setup**: `<INSTALL_DIR>\vscode.ext\memory.md`
...
**Who maintains this**:
- Primary tool: `<INSTALL_DIR>\UnicodeReplacementTool\unicode_replacer.py`
