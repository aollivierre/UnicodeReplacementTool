...
```bash
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\project\service-manager.ps1" --no-backup
```
...
foreach ($file in $files) {
    python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" $file.FullName --no-backup
}
...
for file in $(git diff --name-only --cached); do
    python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "$file" --no-backup
done
```
...
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\project\script.ps1" --preview
...
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\project\script.ps1" --backup
```
...
C:\Python313\python.exe "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" ...
```
...
Test-Path "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py"

# Note the nested folder structure
# Correct:   C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py
# Incorrect: C:\code\UnicodeReplacementTool\unicode_replacer.py
```
...
# Run unicode-remover
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\temp\test-unicode.ps1" --no-backup
...
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\temp\test.ps1" --no-backup
python "C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py" "C:\temp\test.ps1" --no-backup
