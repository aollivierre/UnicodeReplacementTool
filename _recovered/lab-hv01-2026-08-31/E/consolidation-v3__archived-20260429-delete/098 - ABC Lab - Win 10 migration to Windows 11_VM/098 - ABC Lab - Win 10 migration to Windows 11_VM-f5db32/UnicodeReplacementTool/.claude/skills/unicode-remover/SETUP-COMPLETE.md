...
**Location**: `C:\code\UnicodeReplacementTool\.claude\skills\unicode-remover/`
...
**Location**: `C:\code\UnicodeReplacementTool\CLAUDE.md`
...
C:\code\UnicodeReplacementTool\UnicodeReplacementTool\unicode_replacer.py --no-backup
```
...
```
C:\code\UnicodeReplacementTool\.claude\skills\unicode-remover/
```
...
C:\code\UnicodeReplacementTool\.claude\skills\unicode-remover\install-skill.ps1
...
C:\code\UnicodeReplacementTool\.claude\skills\unicode-remover\test-skill.ps1
...
| `RUNONSAVE-SETUP-FOR-USER.md` | VS Code extension setup |
